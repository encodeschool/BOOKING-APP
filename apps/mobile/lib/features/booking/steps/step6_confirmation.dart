...
class _Step6ConfirmationState extends ConsumerState<Step6Confirmation> {
  ...
  Future<void> confirmBooking(WidgetRef ref) async {
    try {
      setState(() {
        loading = true;
      });
      ...
      final response = await apiClient.createBooking({
        ...
        "bookingDate": booking.date!.toIso8601String().split("T")[0],
      ...
      if (response["bookingToken"] != null) {
        ref
            .read(bookingProvider.notifier)
            .setBookingToken(response["bookingToken"].toString());
      }
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (ref.read(bookingProvider).bookingToken != null) ...[
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ref.read(bookingProvider).bookingToken!,
                          ...
                          Text(
                            'Save this token to reschedule or manage your booking later.',
                            style: TextStyle(
                              color: Colors.grey.shade600,
                              fontSize: 13,
                            ),
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  _summaryTile(
                    ...
                    title: "Staff",
                    value: booking.staff?.name ?? "Any available",
                  ),
                  ...
                  if ((booking.customer!["notes"] ?? "").toString().isNotEmpty)
                    _summaryTile(
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              height: 58,
              child: ElevatedButton(
                onPressed: loading ? null : () => confirmBooking(ref),
                style: ElevatedButton.styleFrom(
                  elevation: 0,
                  backgroundColor: Colors.black,
  ...
  Widget _successRow(IconData icon, String title, String value) {
    return Row(
      children: [
        Container(
          width: 42,
